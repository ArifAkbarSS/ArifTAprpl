...
<body>
    ...
    <section class="caviar-about-us-area section-padding-100" ID="karyawan">
		...
		<form method="post" action="updatepegawai.php">
  			<div class="form-group">
    			...
    			<input type="hidden" class="form-control" id="formGroupExampleInput" name="ID_karyawan" value="<?php echo $d['ID_karyawan']; ?>">
			...
			<div class="form-group">
  			...
  			<div class="form-group">
    			...
    			<input type="text" class="form-control" id="formGroupExampleInput2" name="no_hp" value="<?php echo $d['no_hp']; ?>">
			</div>
			<div>
