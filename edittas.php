...
<body>
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-11 col-md-6 col-lg-4">
                            <div class="hero-content">
                                <p>Alat pancing adalah suatu alat untuk menuangkan hobi memancing kita agar mendapat kan 
                                hasil tangkapan tanpa lepas ataupun putus dan bisa mengupgrade alat pancing kita di toko ini dengan murah.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="caviar-about-us-area section-padding-100" id="tas">
		...
		<?php
			include 'koneksi.php';
			$id_tas = $_GET['id_tas'];
			$data = mysqli_query($koneksi,"select * from tas where id_tas='$id_tas'");
			while($d = mysqli_fetch_array($data)){
		?>
		<form method="post" action="updatetas.php">
  			<div class="form-group">
    			<label for="formGroupExampleInput">Nama</label>
    			<input type="hidden" class="form-control" id="formGroupExampleInput" name="id_tas" value="<?php echo $d['id_tas']; ?>">
				<input type="text" class="form-control" id="formGroupExampleInput" name="nama" value="<?php echo $d['nama']; ?>">
			</div>
			<div class="form-group">
    			<label for="formGroupExampleInput2">Harga</label>
    			<input type="text" class="form-control" id="formGroupExampleInput2" name="harga" value="<?php echo $d['harga']; ?>">
			</div>
			<div>
