...
<body>
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-11 col-md-6 col-lg-4">
                            <div class="hero-content">
                                <h2>Lorem Ipsum</h2>
                                <p>Tas adalah wadah tertutup yang dapat dibawa bepergian. 
                                Materi untuk membuat tas antara lain adalah plastik, kulit, kain, dan lain-lain.</p>
                            </div>
                        </div>
                    </div>
                </div>
	...
	<div class="container py-lg-3 py-sm-1">
		<form method="post" action="prosestas.php">
			<form class="needs-validation" novalidate>
  				<div class="form-row">
  					<div class="col-md-4 mb-3">
      					<label for="validationTooltip01">ID </label>
      					<input type="text" class="form-control" id="validationTooltip01" placeholder="Kode Tas" name="id_tas">
    				</div>
    				<div class="col-md-4 mb-3">
                    ...
                    <div class="col-md-4 mb-3">
      					<label for="validationTooltip01">Harga</label>
      					<input type="text" class="form-control" id="validationTooltip01" placeholder="harga" name="harga">
    				</div>
  				</div>
