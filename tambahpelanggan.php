			...
			<form class="needs-validation" novalidate>
  				<div class="form-row">
  					<div class="col-md-4 mb-3">
      					...
      					<input type="text" class="form-control" id="validationTooltip01" placeholder="No Hp" name="no_hp">
    				</div>
    				<div class="col-md-4 mb-3">
      					<label for="validationTooltip01">Nama</label>
      					<input type="text" class="form-control" id="validationTooltip01" placeholder="Nama" name="nama_pel">
                    </div>
                  </div>
                  <div class="form-row align-items-center">
					<div class="form-group col-md-6">
      					<label for="inputCity">Alamat</label>
	  					<input type="text" class="form-control" id="inputCity" placeholder="Alamat" name="alamat">
    				</div>
                    <div class="col-auto my-2">
		        	    <label class="mr-sm-2" for="inlineFormCustomSelect">Karyawan</label>
                        <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="ID_karyawan">
	                    <?php 
	                        include 'koneksi.php';
